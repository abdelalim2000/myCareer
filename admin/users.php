            ...
            <main class="content">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
                    <div class="d-block mb-4 mb-md-0">
                        ...
                        <p class="mb-0">Users Controller</p>
                    </div>
                </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <?php foreach ($data as $person) : ?>
                            <tr>
                                ...
                                <td>
                                    <span class="font-weight-bold">
                                        <?php echo $person['password'] ?>
                                    </span>
                                </td>
                                <td>
                                    <span class="font-weight-bold text-warning">
                                        <?php echo $person['type'] ?>
                                    </span>
                                </td>
                                <td>
                                    <div class="btn-group">
...
<!--                                                        class="fas fa-eye mr-2"></span>View Details</a>-->
                                            <a class="dropdown-item"
                                               href="editUser.php?id=<?php echo $person['id'] ?>"><span
                                                        class="fas fa-edit mr-2"></span>Edit</a>
                                            <a class="dropdown-item text-danger"
                                               href="handleDelete.php?id=<?php echo $person['id'] ?>"><span
