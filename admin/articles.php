...
$articles = $article->getCategArticles($_GET['id']);
...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title><?php echo $_GET['name'] ?> || Articles</title>
            ...
            <main class="content">
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
                    <div class="d-block mb-4 mb-md-0">
                        ...
                        <p class="mb-0"><?php echo $_GET['name'] ?> Articles</p>
                    </div>
                </div>
                                ...
                                <td styl="">
                                    <span class="font-weight-normal">
                                        ...
                                        if (strlen($item['body'] > 200)) {
                                            $char = strlen($item['body']) * .78;
                                            echo substr($item['body'], $char);
                                        }
                                        ?>
                                    </span>
                                </td>
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                   href="articleView.php?id=<?php echo $item['id'] ?>"><span
                                                            class="fas fa-eye mr-2"></span>View Details</a>
                                                <a class="dropdown-item text-danger"
                                                   href="handleArticleDelete.php?id=<?php echo $item['id'] ?>"><span
