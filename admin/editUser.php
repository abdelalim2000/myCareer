...
if (isset($_GET['id'])) {
    $user = $users->readSingleUser($_GET['id']);
}
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="row justify-content-center form-bg-image"
                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="signin-inner my-3 my-lg-0 bg-white shadow-soft border rounded border-light p-4 p-lg-5 w-100 fmxw-500">
                        ...
                        <form action="handleEdit.php?id=<?php echo $_GET['id'] ?>" method="post">
                            <!-- Form -->
                            <div class="row">
                            ...
                            <div class="form-group mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" name="email" class="form-control"
                                           ...
                                           id="email" autofocus required disabled
                                ...
                                <div class="form-group mb-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select name="type" id="role" class="form-select">
                                            <option value="admin" <?php if ($user['type'] === "admin") echo "selected" ?>>
                                                Admin
                                            </option>
                                            <option value="writer" <?php if ($user['type'] === "writer") echo "selected" ?>>
                                                Writer
                                            </option>
                                        </select>
                                    </div>
...
<!--                                </div>-->
                            ...
                            <button type="submit" name="register" class="btn btn-block btn-primary">Register
                            </button>
                        </form>
