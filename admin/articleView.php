...
$artic = $article->getSingleArticle($_GET['id']);
...
<head>
    ...
    <!-- Primary Meta Tags -->
    <title><?php echo $artic['name'] ?></title>
                    ...
                    <div class="d-block mb-4 mb-md-0">
                        <nav aria-label="breadcrumb" class="d-none d-md-inline-block">
                            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><?php echo $artic['name'] ?></li>
                            </ol>
                        </nav>
                        <h2 class="h4">Articles</h2>
                        <p class="mb-0"><?php echo $artic['name'] ?></p>
                    </div>
                </div>
                <div class="card border-light shadow-sm table-wrapper table-responsive pt-0">
                    <div class="card-header">
                        <h3 class="card-title"><?php echo strtoupper($artic['name']) ?></h3>
                        <p class="card-subtitle">by: <?php echo $artic['author'] ?>
                            <span><?php echo $artic['created_at'] ?></span>
                        </p>
                    </div>
                    <div class="card-body">
                        ...
                        <div class="mt-5">
                            <a href="dashboard.php" class="btn btn-primary mr-auto">Back to Dashboard</a>
                        </div>
                    </div>
                </div>
